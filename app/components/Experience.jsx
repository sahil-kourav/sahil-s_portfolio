                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-5">
                    ...
                    <div className="flex flex-row md:flex-col md:items-end gap-2">
                      ...
                      <span className="text-sm px-3 py-2 bg-blue-50 dark:bg-blue-950/30 text-blue-600 dark:text-blue-400 rounded-full border border-blue-200 dark:border-blue-800">
                        {exp.type}
                      </span>
                    </div>
                  </div>
                    ...
                    <div className="mb-6 space-y-2">
                      {exp.achievements.map((achievement, idx) => (
                        <div key={idx} className="flex gap-3">
                          <span className="w-1.5 h-1.5 mt-2 rounded-full bg-gradient-to-r from-blue-600 to-purple-600" />
