...
const About = ({ isDarkMode }) => {
  return (
    <div id="about" className="w-full px-[10%] py-16">
...
rounded-3xl"
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl text-base text-justify text-gray-800 dark:text-gray-300 md:text-justify lg:text-justify">
