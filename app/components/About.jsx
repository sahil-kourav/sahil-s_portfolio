...
rounded-3xl"
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <p className="mb-10 max-w-2xl text-base sm:text-lg md:text-lg text-center md:text-justify lg:text-justify font-Ovo">            
            I build scalable, modern applications with a strong focus on clean
              ...
              JavaScript, React, Next.js, Tailwind CSS, and RESTful
